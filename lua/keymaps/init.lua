...
vim.keymap.set('n', '<Leader>cn', ':cnext<CR>', { silent = true, desc = "Jump forward" })
vim.keymap.set('n', '<Leader>cp', ':cprevious<CR>', { silent = true, desc = "Jump back" })
vim.keymap.set('n', '<Leader>cc', 'win_gettype() ==# "quickfix" ? ":cclose<CR>" : ":copen<CR>"',
